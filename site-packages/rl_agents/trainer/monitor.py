    ...
    def __init__(self, directory, file_prefix, autoreset=False, env_id=None, log_infos=True):
      ...
      #  self.rewards_ = []
       # self.episode_rewards_ = []
        self.rewards__1 = []
        self.episode_rewards__1 = []
        self.rewards__2 = []
        self.episode_rewards__2 = []
        self.rewards__3 = []
        self.episode_rewards__3 = []
 ...
 #       self.rewards_.append(reward)
  #      if self.log_infos and info:
   #         for field, value in info.items():
    ...
    def after_step(self, observation, reward_1, reward_2, reward_3, done, info):
        # Aggregate rewards history
       # self.rewards_.append(reward)
        self.rewards__1.append(reward_1)
        self.rewards__2.append(reward_2)
        self.rewards__3.append(reward_3)
        if self.log_infos and info:
            for field, value in info.items():
                if field not in self.infos:
                    self.infos[field] = []
        ...
        #super(StatsRecorderV2, self).after_step(observation, reward, done, info)
        super(StatsRecorderV2, self).after_step(observation, reward_1, reward_2, reward_3, done, info)
    ...
    def save_complete(self):
        if self.steps is not None:
            ...
            self.episode_rewards__1.append(self.rewards__1)
            self.episode_rewards__2.append(self.rewards__2)
            self.episode_rewards__3.append(self.rewards__3)
    ...
    def flush(self):
        ...
        data = {
            ...
            'episode_rewards_1': self.episode_rewards_1,
            'episode_rewards_2': self.episode_rewards_2,
            'episode_rewards_3': self.episode_rewards_3,
            #yaeli
            #'episode_rewards_': self.episode_rewards_,
            'episode_rewards__1': self.episode_rewards__1,
            'episode_rewards__2': self.episode_rewards__2,
            'episode_rewards__3': self.episode_rewards__3,
