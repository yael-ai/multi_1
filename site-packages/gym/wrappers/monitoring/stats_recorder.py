  ...
  #  def after_step(self, observation, reward, done, info):
   #     self.steps += 1
    ...
    def after_step(self, observation, reward_1, reward_2, reward_3, done, info):
        ...
        self.rewards_3 += reward_3
        #option 2:
        self.rewards_all += self.rewards_1+self.rewards_2+self.rewards_3
    ...
    def save_complete(self):
        if self.steps is not None:
            ...
            self.episode_rewards_3.append(float(self.rewards_3))
